...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference("Estudiante.count") do
      post estudiantes_url, params: { estudiante: { Apellido: @estudiante.apellido, Cuerso: @estudiante.curso, Edad: @estudiante.edad, Nombre: @estudianten.nombre, Nota: @estudiante.nota  } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { Apellido: @estudiante.apellido, Cuerso: @estudiante.curso, Edad: @estudiante.edad, Nombre: @estudianten.nombre, Nota: @estudiante.nota  } }
